import CollaborateForm from "../components/forms/Collaborate";
      ...
      <div className="page_head_set flex">
        ...
        <div className="page_paragraph">
          <div className="content_a">
            <div className="f_20 less_opacity">{collaborator.description}</div>
          </div>
        </div>
      </div>
      ...
      <div id="sections">
          ...
          <div className="section_content near">
            <div className="line_section flex">
              ...
              >
                <img
                  className="load_img"
                  data-src={`${CMSPath}${collaborator.centerCover.url}`}
                  width="100%"
                  height="auto"
                  alt={collaborator.centerCover.alternativeText}
                />
              </div>
        ...
        <section>
          <div className="section_content">
            {collaborator.titleDescriptionBlock && (
              <div className="content_a">
                <div className="section_sides text_sides flex">
                  <div className="text_side">
                    <div className="f_80 alt">
                      {collaborator.titleDescriptionBlock.title}
                    </div>
                  </div>
                  ...
                  <div className="text_side">
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: collaborator.titleDescriptionBlock.description,
                      }}
                    />
                  </div>
                </div>
            ...
            {collaborator.images && (
              <div className="three_images">
                ...
                <div className="ti_images flex">
                  <div
                    className="ti_col flex"
                    data-scroll
                    data-scroll-direction="vertical"
                    data-scroll-speed="1"
                  >
                    <div className="ti_img">
                      <img
                        className="load_img"
                        data-src={`${CMSPath}${collaborator.images[0].image.url}`}
                        width="100%"
                        height="auto"
                        alt={collaborator.images[0].image.alternativeText}
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="ti_img">
                      <img
                        className="load_img"
                        data-src={`${CMSPath}${collaborator.images[1].image.url}`}
                        width="100%"
                        height="auto"
                        alt={collaborator.images[1].image.alternativeText}
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div className="ti_img">
                      <img
                        className="load_img"
                        data-src={`${CMSPath}${collaborator.images[2].image.url}`}
                        width="100%"
                        height="auto"
                        alt={collaborator.images[2].image.alternativeText}
                      />
                    </div>
                  </div>
                </div>

                <div className="line_shape ti_shape_set">
                  <svg
        ...
        {collaborator.collaboratorsBlock && (
          <section>
            <div className="section_content">
              <div className="content_a">
                <div className="hero_text flex">
                  ...
                  <div className="f_20 less_opacity">
                    {collaborator.collaboratorsBlock.description}
                  </div>
                </div>

                <div className="table_set has_margin no-select">
                  {collaborator.collaboratorsBlock.brands.map((brand, key) => {
                    <div className="table_row flex">
                      ...
                      <div className="table_col flex">
                        <span className="f_20 uppercase">{brand.location}</span>
                      </div>
                    </div>;
                  })}
                </div>
        ...
        {collaborateWithUs && (
          <CollaborateForm sectionData={collaborateWithUs} />
        )}
