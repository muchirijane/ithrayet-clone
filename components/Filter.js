        ...
        <div className="filters_set">
          ...
          <div className="filters_body">
            <div className="filters_scroll">
              ...
              {data.alphabetLastName && (
                <div className="filter_block _ele" id="alphabetLastName">
                  <div className="filter_head flex">
                    <strong className="f_20 uppercase">
                      {t("by_alphabet_ln")}
                    </strong>
              ...
              {data.sorting && (
                <div className="filter_block _ele" id="sortBy">
                  <div className="filter_head flex">
                    <strong className="f_20 uppercase">{t("sort_by")}</strong>
                    <div className="filter_side">
                      <div className="filter_arrow">
                        <svg
                          width="14"
                  ...
                  <div className="filter_options f_16 uppercase">
                    <div className="options_wrap">
                      <div className="options_list">
                        {data.sorting.map((tag, key) => (
                          <div
                            className="option flex single"
                            key={`sorting-${tag.val}`}
                          >
                            <div className="option_side" data-id={`${tag.val}`}>
                              {`${tag.name}`}
                            </div>
          ...
          <div className="filters_action _ele">
            ...
            >
              ...
              {data.alphabetLastName && (
                <input type="hidden" name="alphabetLastName" value="" />
              )}
              ...
              {data.sorting && <input type="hidden" name="sortBy" value="" />}
